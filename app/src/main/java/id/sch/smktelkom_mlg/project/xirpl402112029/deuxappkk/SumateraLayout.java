...
/**
 * Created by SUPER USER on 20/11/2016.
 */

public class SumateraLayout extends AppCompatActivity {
    ...
    private void fillData() {
        ...
        String[] arJudul = resources.getStringArray(R.array.sumatera_places);
        String[] arDeskripsi = resources.getStringArray(R.array.sumatera_desc);
        TypedArray a = resources.obtainTypedArray(R.array.sumatera_pictures);
